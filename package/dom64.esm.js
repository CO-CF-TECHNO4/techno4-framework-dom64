...
function $(selector, context) {
  ...
  let arr = [];
  if (!context && selector instanceof DOM64$1) {
    return selector;
  }
  if (!selector) {
    return new DOM64$1(arr);
  }
  if (typeof selector === 'string') {
    ...
    if (selector instanceof DOM64$1) return selector;
    arr = selector;
  }
  return new DOM64$1(arrayUnique(arr));
}
$.fn = DOM64$1.prototype;
...
function is(selector) {
  ...
  if (selector.nodeType || selector instanceof DOM64$1) {
...
function append() {
  ...
  for (let k = 0; k < arguments.length; k += 1) {
    ...
    for (let i = 0; i < this.length; i += 1) {
      ...
      } else if (newChild instanceof DOM64$1) {
...
function add() {
  ...
  let i;
  let j;
  for (var _len0 = arguments.length, els = new Array(_len0), _key0 = 0; _key0 < _len0; _key0++) {
    els[_key0] = arguments[_key0];
  }
...
export { $, add, addClass, animate, animationEnd, append, appendTo, attr, blur, change, children, click, closest, css, data, dataset, $ as default, detach, each, empty, eq, filter, find, focus, focusin, focusout, hasClass, height, hide, html, index, insertAfter, insertBefore, is, keydown, keypress, keyup, mousedown, mouseenter, mouseleave, mousemove, mouseout, mouseover, mouseup, next, nextAll, off, offset, on, once, outerHeight, outerWidth, parent, parents, prepend, prependTo, prev, prevAll, prop, remove, removeAttr, removeClass, removeData, resize, scroll, scrollLeft, scrollTo, scrollTop, show, siblings, stop, styles, submit, text, toggleClass, touchend, touchmove, touchstart, transform, transition, transitionEnd, transitionStart, trigger, val, value, width };
